...
var draw_graph = function(graphType, obj) {
	...
	var mousedown = function(e) {
		...
		e = e || window.event;
		startX = e.clientX - canvasLeft + $(".canvas-wrap-div").scrollLeft();
		startY = e.clientY - canvasTop + $(".canvas-wrap-div").scrollTop();
		...
		if(graphType == 'pencil') {
			...
			context.beginPath();
//			context.moveTo(startX, startY);  // 去除这项，画圆的中心点不会产生黑点
	...
	var mouseup = function(e) {
		...
		if(graphType != 'rubber') {
			...
			var x = e.clientX - canvasLeft + $(".canvas-wrap-div").scrollLeft();
			var y = e.clientY - canvasTop + $(".canvas-wrap-div").scrollTop();
			context.beginPath();
//			context.moveTo(x, y);     // 去掉这项，鼠标松开不会产生黑点
